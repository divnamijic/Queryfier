...
public class AttributeAutoIncrementHandler implements EventHandler<ActionEvent> {

    private final QueryfierDisplay display;
    private final QueryfierStorage storage;

    public AttributeAutoIncrementHandler(QueryfierDisplay display, QueryfierStorage storage) {
    ...
    public void handle(ActionEvent event) {
        ...
        boolean newAttributeAutoIncrementValue = event.getSource() instanceof CheckBox cBox && cBox.isSelected();
        ...
        attribute.setAutoIncrement(newAttributeAutoIncrementValue);
    }
