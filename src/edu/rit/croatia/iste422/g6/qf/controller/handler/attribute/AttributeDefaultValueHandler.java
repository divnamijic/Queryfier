...
public class AttributeDefaultValueHandler implements EventHandler<KeyEvent> {

    private final QueryfierDisplay display;
    private final QueryfierStorage storage;

    public AttributeDefaultValueHandler(QueryfierDisplay display, QueryfierStorage storage) {
    ...
    public void handle(KeyEvent event) {
        ...
        String newAttributeDefaultValue = event.getSource() instanceof TextField tf ? tf.getText() : "";
        ...
        attribute.setDefaultValue(newAttributeDefaultValue);
    }
