...
public class AttributeSignedHandler implements EventHandler<ActionEvent> {

    private final QueryfierDisplay display;
    private final QueryfierStorage storage;

    public AttributeSignedHandler(QueryfierDisplay display, QueryfierStorage storage) {
    ...
    public void handle(ActionEvent event) {
        boolean newAttributeSigned = event.getSource() instanceof CheckBox cBox && cBox.isSelected();
        ...
        attribute.setSigned(newAttributeSigned);
    }
